...
-- CreateEnum
CREATE TYPE "RoleName" AS ENUM ('SUPER_ADMIN', 'ADMIN', 'MANAGER', 'SUPPORT', 'CUSTOMER', 'DELIVERY');

-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'PAYMENT_PROCESSING', 'PAID', 'PROCESSING', 'SHIPPED', 'OUT_FOR_DELIVERY', 'DELIVERED', 'CANCELLED', 'REFUNDED', 'FAILED');
...
-- CreateEnum
CREATE TYPE "InventoryTxnType" AS ENUM ('ADJUSTMENT', 'RESERVE', 'RELEASE', 'DEDUCT', 'RESTOCK', 'RETURN');
...
-- CreateIndex
CREATE INDEX "TrackingEvent_deliveryId_occurredAt_idx" ON "TrackingEvent"("deliveryId", "occurredAt");
